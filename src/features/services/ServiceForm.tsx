...
import { ChevronLeft, Briefcase, Tag, DollarSign, Save } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center justify-between">
                <label htmlFor="expense" className="text-muted-foreground font-semibold flex items-center gap-1">
                  <DollarSign size={13} /> Our Expense / Cost Price (AED)
                </label>
                <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400">
                  Est. Profit: {(form.price - form.expense).toFixed(2)} AED
                </span>
              </div>
              <input
                id="expense"
                ...
                disabled={loading}
              />
              <p className="text-[10px] text-muted-foreground">Internal cost incurred to deliver this service item.</p>
            </div>
          </div>
